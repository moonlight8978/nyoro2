class Admin::Db::ListController < Admin::ManagementController
  helper_method :edit_path_for, :show_path_for
...
protected
  ...
  def search_for_resources(**args)
    resource_class.search(include: :editor) do
